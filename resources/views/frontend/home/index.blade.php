        ...
        <div class="container">
            ...
            <div class="row gx-0 services__active">
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="{{asset('assets/img/images/services_img01.jpg')}}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{asset('assets/img/icons/services_light_icon01.png')}}" alt="">
                                <img class="dark" src="{{asset('assets/img/icons/services_icon01.png')}}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="{{asset('assets/img/images/services_img02.jpg')}}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{asset('assets/img/icons/services_light_icon02.png')}}" alt="">
                                <img class="dark" src="{{asset('assets/img/icons/services_icon02.png')}}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="{{asset('assets/img/images/services_img03.jpg')}}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{asset('assets/img/icons/services_light_icon03.png')}}" alt="">
                                <img class="dark" src="{{asset('assets/img/icons/services_icon03.png')}}" alt="">
                            </div>
                ...
                <div class="col-xl-3">
                    <div class="services__item">
                        <div class="services__thumb">
                            <a href="services-details.html"><img src="{{asset('assets/img/images/services_img04.jpg')}}" alt=""></a>
                        </div>
                        <div class="services__content">
                            <div class="services__icon">
                                <img class="light" src="{{asset('assets/img/icons/services_light_icon04.png')}}" alt="">
                                <img class="dark" src="{{asset('assets/img/icons/services_icon04.png')}}" alt="">
                            </div>
            ...
            <div class="row work__process__wrap">
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light" src="{{asset('assets/img/icons/wp_light_icon01.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/wp_icon01.png')}}" alt="">
                        </div>
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light" src="{{asset('assets/img/icons/wp_light_icon02.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/wp_icon02.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light" src="{{asset('assets/img/icons/wp_light_icon03.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/wp_icon03.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                ...
                <div class="col">
                    <div class="work__process__item">
                        ...
                        <div class="work__process__icon">
                            <img class="light" src="{{asset('assets/img/icons/wp_light_icon04.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/wp_icon04.png')}}" alt="">
                        </div>
                        <div class="work__process__content">
                            ...
                            <div class="portfolio__active">
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img01.jpg')}}" alt="">
                                    </div>
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img02.jpg')}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img03.jpg')}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img04.jpg')}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img05.jpg')}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img06.jpg')}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{asset('assets/img/portfolio/portfolio_img07.jpg')}}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>Web Development</span>
                                        <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <ul class="partner__logo__wrap">
                        <li>
                            <img class="light" src="{{asset('assets/img/icons/partner_light01.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/partner_01.png')}}" alt="">
                        </li>
                        <li>
                            <img class="light" src="{{asset('assets/img/icons/partner_light02.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/partner_02.png')}}" alt="">
                        </li>
                        <li>
                            <img class="light" src="{{asset('assets/img/icons/partner_light03.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/partner_03.png')}}" alt="">
                        </li>
                        <li>
                            <img class="light" src="{{asset('assets/img/icons/partner_light04.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/partner_04.png')}}" alt="">
                        </li>
                        <li>
                            <img class="light" src="{{asset('assets/img/icons/partner_light05.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/partner_05.png')}}" alt="">
                        </li>
                        <li>
                            <img class="light" src="{{asset('assets/img/icons/partner_light06.png')}}" alt="">
                            <img class="dark" src="{{asset('assets/img/icons/partner_06.png')}}" alt="">
                        </li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6 order-0 order-lg-2">
                    <ul class="testimonial__avatar__img">
                        <li><img src="{{asset('assets/img/images/testi_img01.png')}}" alt=""></li>
                        <li><img src="{{asset('assets/img/images/testi_img02.png')}}" alt=""></li>
                        <li><img src="{{asset('assets/img/images/testi_img03.png')}}" alt=""></li>
                        <li><img src="{{asset('assets/img/images/testi_img04.png')}}" alt=""></li>
                        <li><img src="{{asset('assets/img/images/testi_img05.png')}}" alt=""></li>
                        <li><img src="{{asset('assets/img/images/testi_img06.png')}}" alt=""></li>
                        <li><img src="{{asset('assets/img/images/testi_img07.png')}}" alt=""></li>
                    </ul>
                </div>
                <div class="col-xl-5 col-lg-6">
